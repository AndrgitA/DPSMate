...
function DPSMate.Modules.DetailsCureDiseaseTotal:UpdateRow(row, a, b, c, d, e)
	...
	if c == "" then
		...
		_G("DPSMate_Details_CureDisease_Total_LogDetails_Row" .. row .. "_Cause"):SetText("|cFF" .. hexClassColor[(DPSMateUser[c] and DPSMateUser[c][2]) or "warrior"] .. c .. "|r")
	end
	if d == "" then
		_G("DPSMate_Details_CureDisease_Total_LogDetails_Row" .. row .. "_Target"):SetText("")
	else
		_G("DPSMate_Details_CureDisease_Total_LogDetails_Row" .. row .. "_Target"):SetText("|cFF" .. hexClassColor[(DPSMateUser[d] and DPSMateUser[d][2]) or "warrior"] .. d .. "|r")
	end
