if (GetLocale() == "deDE") then
	...
	DPSMate.L["bccdo"] = function(who, what)
		return who .. " bekommt " .. what
	end
	DPSMate.L["bccdt"] = function(who, what)
		return who .. "s " .. what .. " schwindet"
	end
	DPSMate.L["bcress"] = function(who, what)
		return what .. " wurde wiederbelebt von " .. who
	end
	DPSMate.L["bckb"] = function(who, what, with, value)
		return who .. " wurde getötet von " .. what .. "s " .. with .. " (" .. value .. " Schaden)"
	end
	DPSMate.L["bcfailo"] = function(what, who, value, with)
		return "Fail: " .. what .. " fügt freundlichem Ziel " .. who .. " " .. value .. " Schaden zu mit " .. with
	end
	DPSMate.L["bcfailt"] = function(who, with)
		return "Fail: " .. who .. " ist betroffen von " .. with
	end
	DPSMate.L["bcfailth"] = function(who, value, with, what)
		return "Fail: " .. who .. " leidet " .. value .. " Schaden von " .. with .. " von " .. what
	end
	...
	local substr = "Menu_"
		...
		DPSMate.Options.Options[1]["args"]["damage"] = {
			...
			get = function()
				return DPSMateSettings["windows"][DPSMate.Options.Dewdrop:GetOpenedParent().Key]["options"][1]["damage"]
			end,
			set = function()
				DPSMate.Options:ToggleDrewDrop(1, "damage", DPSMate.Options.Dewdrop:GetOpenedParent())
			end,
		}
		DPSMate.Options.Options[1]["args"]["dps"] = {
			...
			get = function()
				return DPSMateSettings["windows"][DPSMate.Options.Dewdrop:GetOpenedParent().Key]["options"][1]["dps"]
			end,                                                                                                          -- Addons might conflicting here with dewdrop
			set = function()
				DPSMate.Options:ToggleDrewDrop(1, "dps", DPSMate.Options.Dewdrop:GetOpenedParent())
			end,
		}
